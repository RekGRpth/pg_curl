...
EXTENSION(pg_curlsslopt_revoke_best_effort) { PG_RETURN_INT64(CURLSSLOPT_REVOKE_BEST_EFFORT); }
EXTENSION(pg_curlsslopt_native_ca) { PG_RETURN_INT64(CURLSSLOPT_NATIVE_CA); }
EXTENSION(pg_curlsslopt_auto_client_cert) { PG_RETURN_INT64(CURLSSLOPT_AUTO_CLIENT_CERT); }
...
EXTENSION(pg_curlauth_aws_sigv4) { PG_RETURN_INT64(CURLAUTH_AWS_SIGV4); }
