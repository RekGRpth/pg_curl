...
select curl_easy_getinfo_errcode(conname:='1'), curl_easy_getinfo_errbuff(conname:='1');
select curl_easy_getinfo_errcode(conname:='2'), curl_easy_getinfo_errbuff(conname:='2');
select curl_easy_getinfo_errcode(conname:='3'), curl_easy_getinfo_errbuff(conname:='3');
ROLLBACK;
