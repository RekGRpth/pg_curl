...
CREATE OR REPLACE FUNCTION pg_curl_mime_filedata(filename text, base text default none) RETURNS boolean AS 'MODULE_PATHNAME', 'pg_curl_mime_filedata' LANGUAGE 'c';
