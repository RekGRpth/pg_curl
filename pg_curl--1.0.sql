...
CREATE OR REPLACE FUNCTION pg_curl_mime_data(data bytea, name text default null, file text default null, type text default null, code text default null) RETURNS boolean AS 'MODULE_PATHNAME', 'pg_curl_mime_data_bytea' LANGUAGE 'c';
CREATE OR REPLACE FUNCTION pg_curl_mime_data(data bytea[], name text[] default null, file text[] default null, type text[] default null, code text[] default null) RETURNS boolean AS 'MODULE_PATHNAME', 'pg_curl_mime_data_array_bytea' LANGUAGE 'c';
...
CREATE OR REPLACE FUNCTION pg_curl_mime_file(data text, name text default null, file text default null, type text default null, code text default null) RETURNS boolean AS 'MODULE_PATHNAME', 'pg_curl_mime_file' LANGUAGE 'c';
CREATE OR REPLACE FUNCTION pg_curl_mime_file(data text[], name text[] default null, file text[] default null, type text[] default null, code text[] default null) RETURNS boolean AS 'MODULE_PATHNAME', 'pg_curl_mime_file_array' LANGUAGE 'c';
